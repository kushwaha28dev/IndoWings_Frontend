      ...
      <div className="max-w-[1240px] mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-sm sm:text-base text-zinc-300/80 leading-relaxed mt-3 max-w-xl">
          ...
          <div className="flex items-center gap-3.5 flex-wrap shrink-0">
            <button 
              ...
              className="inline-flex items-center gap-2 px-5 py-3 rounded-lg bg-[#250052] border border-zinc-700 text-white text-sm font-semibold hover:bg-[#1a003d] transition-all shadow-md active:scale-95"
            >
