    ...
    <div className="min-h-screen bg-[#f8f6fc]">
      ...
      <section 
        ...
        <div className="relative max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/10 border border-white/15 rounded-full text-xs font-bold text-zinc-400 mb-4 shadow-sm">
          ...
          <div className="max-w-xl mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 rounded-2xl bg-white text-[#171222] placeholder-slate-400 text-sm font-medium shadow-xl focus:outline-none focus:ring-4 focus:ring-zinc-400/20 transition-all"
            />
            {searchQuery && (
              <button 
            ...
            <button
              ...
              className={`flex-1 py-3 px-3 sm:px-4 rounded-xl text-xs sm:text-sm font-bold transition-all flex items-center justify-center gap-2 cursor-pointer ${
                activeTab === id
                  ...
                  : 'text-slate-600 hover:text-black hover:bg-zinc-100'
              }`}>
        ...
        {activeTab === 'expert' && (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start animate-in fade-in duration-200">
            ...
            <div className="lg:col-span-7 bg-white rounded-3xl border border-slate-200 shadow-sm p-6 sm:p-8">
              <div className="mb-6">
                <span className="text-xs font-bold text-zinc-800 bg-zinc-100 px-3 py-1 rounded-full uppercase tracking-wider">
                ...
                <form onSubmit={handleSubmitExpertRequest} className="space-y-4">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          required
                          className="w-full pl-10 pr-3 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-black focus:ring-2 focus:ring-zinc-300"
                        />
                      </div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-3.5 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-black focus:ring-2 focus:ring-zinc-300 bg-white">
                      ...
                      {[
                        ...
                        <button
                          ...
                          className={`py-2 px-2 text-[11px] font-bold rounded-xl border transition-all text-center cursor-pointer ${
                            preferredTime === t
                              ? 'bg-zinc-100 text-zinc-900 border-black ring-1 ring-zinc-400'
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-3.5 py-2.5 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-black focus:ring-2 focus:ring-zinc-300 resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-black hover:bg-zinc-800 text-white rounded-xl text-sm font-bold shadow-md shadow-black/10 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-60">
                    {isSubmitting ? (
                      <>
            ...
            <div className="lg:col-span-5 space-y-5">
              ...
              <div className="bg-zinc-100 border border-zinc-200 rounded-3xl p-6 text-xs text-slate-600 space-y-2.5">
          ...
          <div className="space-y-8 animate-in fade-in duration-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm space-y-4">
                ...
                <div className="p-3.5 bg-slate-50 rounded-2xl space-y-2 text-xs">
                  <div className="flex items-center justify-between border-b border-slate-200/70 pb-2">
                    ...
                    <strong className="text-zinc-900 font-bold">5.0 kg Max</strong>
                  </div>
                  <div className="flex items-center justify-between border-b border-slate-200/70 pb-2">
              ...
              <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm space-y-4">
                ...
                <div className="p-3.5 bg-zinc-100 rounded-2xl border border-zinc-200 text-xs space-y-2">
              ...
              <div className="bg-white rounded-3xl border border-slate-200 p-6 shadow-sm space-y-4">
                ...
                <div className="space-y-3 text-xs">
                  <div className="flex items-center gap-3 p-2.5 bg-slate-50 rounded-xl">
                    <span className="w-6 h-6 rounded-full bg-black text-white text-[10px] font-bold flex items-center justify-center">1</span>
                    <div>
                  ...
                  <div className="flex items-center gap-3 p-2.5 bg-slate-50 rounded-xl">
                    <span className="w-6 h-6 rounded-full bg-black text-white text-[10px] font-bold flex items-center justify-center">2</span>
                    <div>
                  ...
                  <div className="flex items-center gap-3 p-2.5 bg-slate-50 rounded-xl">
                    <span className="w-6 h-6 rounded-full bg-black text-white text-[10px] font-bold flex items-center justify-center">3</span>
                    <div>
            ...
            <div className="p-6 bg-zinc-900 border border-zinc-800 rounded-3xl text-white flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-xl">
              <div>
              ...
              <button
                ...
                className="px-6 py-3 bg-white text-zinc-900 font-black rounded-xl text-xs sm:text-sm hover:bg-slate-100 transition-all shrink-0 cursor-pointer shadow-md">
                Book Drone Delivery →
              </button>
            </div>
          </div>
          ...
          <div className="space-y-6 animate-in fade-in duration-200">
                  ...
                  <button
                    ...
                    className={`px-3.5 py-1.5 rounded-xl text-xs font-bold transition-all whitespace-nowrap cursor-pointer ${
                      fixCategoryFilter === c.id
                        ...
                        : 'bg-slate-100 text-slate-600 hover:bg-zinc-100 hover:text-zinc-900'
                    }`}>
                    {c.label}
                  </button>
                ))}
                ...
                return (
                  <div 
                    ...
                    className={`bg-white rounded-2xl border transition-all overflow-hidden ${
                      isOpen ? 'border-black ring-2 ring-zinc-300 shadow-sm' : 'border-slate-200 hover:border-slate-300'
                    }`}>
                    <button
                      type="button"
                      ...
                      <div className={`w-8 h-8 rounded-full flex items-center justify-center shrink-0 transition-all ${
                        isOpen ? 'bg-zinc-100 text-zinc-900' : 'bg-slate-100 text-slate-400'
                      }`}>
                        ...
                        <div className="pt-2 flex items-center gap-3">
                          {fix.actionPage && (
                            <button
                              ...
                              className="px-4 py-2 bg-black hover:bg-zinc-800 text-white font-bold text-xs rounded-xl transition-all shadow-xs flex items-center gap-1.5 cursor-pointer">
            ...
            <div className="p-6 bg-white rounded-3xl border border-zinc-200 text-center space-y-2">
              ...
              <button
                ...
                className="mt-2 inline-flex items-center gap-1.5 px-5 py-2.5 bg-zinc-100 hover:bg-zinc-100 text-zinc-900 font-bold text-xs rounded-xl transition-all border border-zinc-200 cursor-pointer">
